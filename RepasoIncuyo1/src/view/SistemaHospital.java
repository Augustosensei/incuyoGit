 ...
 * @author augus
 */
public class SistemaHospital extends javax.swing.JFrame {

    /**
     * Creates new form SistemaHospital
     */
    ...
    private void mMedicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mMedicoActionPerformed
        Utils.Utilis.seleccion = 'm';
        new VentanaPersona(this,  true).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SistemaHospital.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
